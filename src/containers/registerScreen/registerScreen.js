...
function renderLogo() {
  return (
    <Spring
      ...
      to={{ opacity: 1 }}
      config={{
        tension: 210, friction: 20, delay: 50,
      }}
    >
      {( style ) => (
        <View style={style}>
...
function renderRegister() {
  return (
    <Spring
      ...
      to={{ opacity: 1 }}
      config={{
        tension: 210, friction: 20, delay: 500,
      }}
    >
      {( style ) => (
        <View style={style}>
          <View style={Style.socialLogin}>
            ...
            <TouchableOpacity onPress={() => props.LoginRegister( true )}><Text style={Style.registerBtn}> Login!</Text></TouchableOpacity>
          </View>
        </View>
      )}
    </Spring>
...
return (
  <View style={Style.registerScreenCont}>
    ...
    <View style={Style.textInput}>
      ...
      <Button type="outline" title="Register" color="black" disabled={false} icon="user" onPressFunction={() => console.log( 'Register!!' )} delay={300} />
      <Button type="solid" title="Register with Facebook" color="white" disabled={false} icon="facebook" onPressFunction={() => console.log( 'Facebook!!' )} delay={400} />
    </View>
    {renderRegister()}
  </View>
)
